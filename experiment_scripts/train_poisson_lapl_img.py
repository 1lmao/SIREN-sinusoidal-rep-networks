'''Reproduces Paper Sec. 4.1, Supplement Sec. 3, reconstruction from laplacian.
'''
...
if opt.dataset == 'camera':
    ...
    coord_dataset = dataio.Implicit2DWrapper(img_dataset, sidelength=256, compute_diff='laplacian')
...
# Define the loss
loss_fn = loss_functions.laplace_mse
summary_fn = utils.write_laplace_summary
