...
```
python experiment_scipts/train_video.py --model_type=sine --experiment_name=YOURDESIREDEXPERIMENTNAME
```
...
```
python experiment_scripts/train_sdf.py --model_type=sine --point_cloud_path=<path_to_the_model_in_xyz_format> --batch_size=250000 --experiment_name=YOURDESIREDEXPERIMENTNAME
```
...
```
python experiments_scripts/test_sdf.py --checkpoint_path=<path_to_the_checkpoint_of_the_trained_model> --experiment_name=YOURDESIREDEXPERIMENTNAME
```
